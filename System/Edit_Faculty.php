            ...
            <li class="nav-item active">
                ...
                <div id="Faculties" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ManageFaculties.php">Manage Faculties</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Update Faculty [<?=$_GET['id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="faculty_name" name="faculty_name" type="text" value="<?=$faculty_name?>" placeholder="Faculty Name" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `faculty` SET `faculty_name`='$faculty_name' WHERE faculty.faculty_id = '$id';";
