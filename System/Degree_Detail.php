            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage Degrees</h1>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        $sql = "SELECT * FROM `course`,`lecturer` WHERE course.degree_id = '$degree_id' and course.year='$year' and course.semester='$semester' and lecturer.lecturer_id = course.lecturer_id;";
                                        $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td><a href='Edit_Course.php?c_id=".$row["course_id"]."'>Edit</a></td>
                                                    <td><a href='Remove_Course.php?c_id=".$row["course_id"]."'>Remove</a></td>
                                                    </tr>";
                                                }
                                            }
                                        }
