                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `lecturer`, `user`, `faculty` where lecturer.user_id = user.user_id and lecturer.faculty_id = faculty.faculty_id;";
                                        $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td><a href='Details.php?l_id=".$row["lecturer_id"]."'>Details</a></td>
                                                    </tr>";
                                                }
                                            } 
                                        ?>
