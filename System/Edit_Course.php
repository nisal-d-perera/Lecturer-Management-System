...
if ($_GET['c_id']) {
    $sql = "SELECT * FROM `course` WHERE `course_id`='".$_GET['c_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Courses" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item active" href="ManageCourse.php">Manage Courses</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Update Course [<?=$deg_id?>][<?=$_GET['c_id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="course_name" name="course_name" type="text" value="<?=$course_name?>" placeholder="Course Name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="year">Year</label>
                                                <input class="form-control" id="year" name="year" type="text" value="<?=$year?>" placeholder="Year" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="semester">Semester</label>
                                                <input class="form-control" id="semester" name="semester" type="text" value="<?=$sem?>" placeholder="Semester" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="duration">Duration</label>
                                                <input class="form-control" id="duration" name="duration" type="text" value="<?=$du?>" placeholder="Duration" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="credit">Credit</label>
                                                <input class="form-control" id="credit" name="credit" type="text" value="<?=$cr?>" placeholder="Credit" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="lecturer_id">Lecturer ID</label>
                                                <input class="form-control" id="lecturer_id" name="lecturer_id" type="text" value="<?=$lec_id?>" placeholder="Lecturer ID" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `course` SET `course_name`='$cou_name',`year`='$ye',`semester`='$sem',`duration`='$dur',`credit`='$cre',`lecturer_id`='$lec_id' WHERE course.course_id= '$c_id';";
