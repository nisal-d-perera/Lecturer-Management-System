...
$sql = "SELECT * FROM `degree`,`department` WHERE `degree`.`department_id` = `department`.`department_id` AND `degree`.`degree_id` = '".$_POST['degree_id']."';";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><?=$fac_name?> / <?=$dep_name?> / <?=$deg_name?></h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        $sql = "SELECT * FROM `course`,`lecturer` WHERE course.degree_id = '$degree_id' and lecturer.lecturer_id = course.lecturer_id;";
                                        $result = $conn->query($sql);
