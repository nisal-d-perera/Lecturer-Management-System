                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="user_name" name="user_name" type="text" placeholder="Username" required>
                                            </div>
                                            <div class="mb-3">
...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `user`( `user_id`, `user_name`, `password`, `type`) VALUES ('$user_id','$user_name','$password','$type')";
    $conn->query($sql);
