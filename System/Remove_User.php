...
if ($_GET['u_id']) {
    $sql = "SELECT * FROM `user` WHERE `user_id`='".$_GET['u_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Users" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item active" href="ManageUser.php">Manage Users</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Remove User [<?=$_GET['u_id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
               
                                            
                                            <center>
                                                <h5><?=$u_name?> permently delete from your database </h5>
...
if (isset($_POST['ok'])) {
    ...
    $u_id=$_GET['u_id'];
    $sql="DELETE FROM `user` WHERE user.user_id = '$u_id'";
