...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Courses" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item" href="ManageCourse.php">Manage Courses</a>
                        <a class="collapse-item active" href="Add_New_Course.php">Add New Course</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="course_id" type="text" name="course_id" placeholder="Course ID" required>
                                            </div>
                                            <!-- Form Group (confirm password)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="degree_id">Degree ID</label>
                                                <input class="form-control" id="degree_id" name="degree_id" type="text" placeholder="Degree ID" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="course_name">Course Name</label>
                                                <input class="form-control" id="course_name" type="text" name="course_name" placeholder="Course Name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="year">Year</label>
                                                <input class="form-control" id="year" type="number" name="year" placeholder="Year" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="semester">Semester</label>
                                                <input class="form-control" id="semester" type="number" name="semester" placeholder="Semester" required>
                                            </div>
                                            <!-- Form Group (confirm password)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="duration">Duration</label>
                                                <input class="form-control" id="duration" name="duration" type="number" placeholder="Hours" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="credit">Credit</label>
                                                <input class="form-control" id="credit" type="number" name="credit" placeholder="Credit" required>
                                            </div>
                                            <div class="mb-3">
...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `course`(`course_id`, `degree_id`, `course_name`, `year`, `semester`, `duration`, `credit`, `lecturer_id`) VALUES ('$cou_id','$deg_id','$cou_name','$year','$sem','$dur','$cre','$l_id');";
    $conn->query($sql);
