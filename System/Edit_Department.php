...
if ($_GET['d_id']) {
    $sql = "SELECT * FROM `department` WHERE `department_id`='".$_GET['d_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();

    $department_name=$row["department_name"];
    $coor_id=$row["coordinator_id"];
...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Departments" class="collapse show" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item active" href="ManageDepartment.php">Manage Departments</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Update Department [<?=$_GET['d_id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="department_name" name="department_name" type="text" value="<?=$department_name?>" placeholder="Department Name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="coordinator_id">Coordinator ID</label>
                                                <input class="form-control" id="coordinator_id" name="coordinator_id" type="text" value="<?=$coor_id?>" placeholder="Coordinator ID" required>
                                            </div>
                                            <div class="mb-3">
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `department` SET `department_name`='$department_name',`coordinator_id`='$coordinator_id',`faculty_id`='$faculty_id' WHERE department.department_id= '$d_id';";
    $conn->query($sql);
