...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Lecturers" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item" href="ManageLectures.php">Manage Lecturers</a>
                        <a class="collapse-item active" href="Add_New_Lectures.php">Add New Lecturer</a>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1" for="lecturer_id">Lecturer ID</label>
                                                <input class="form-control" id="lecturer_id" type="text" name="lecturer_id" placeholder="Lecturer ID" required>
                                            </div>
                                            <!-- Form Group (confirm password)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="lecturer_name">Lecturer Name</label>
                                                <input class="form-control" id="lecturer_name" name="lecturer_name" type="text" placeholder="Lecturer Name" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1" for="nic">NIC No</label>
                                                <input class="form-control" id="nic" name="nic" type="text" placeholder="NIC No" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="start_date">Start Date</label>
                                                <input class="form-control" id="start_date" name="start_date" type="date" placeholder="Start Date" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="phone_number">Phone Number</label>
                                                <input class="form-control" id="phone_number" name="phone_number" type="tel" placeholder="077-1234567" pattern="[0-9]{3}-[0-9]{7}" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="birth_date" name="birth_date" type="date" placeholder="Start Date" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="type">Type</label>
                                                <input class="form-control" id="type" name="type" type="text" placeholder="Lecturer/Coordinator" required>
                                            </div> 
                                            <div class="mb-3">
                                                <label class="small mb-1" for="faculty_id">Faculty ID</label>
                                                <input class="form-control" id="faculty_id" name="faculty_id" type="text" placeholder="Faculty ID" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="user_id">User ID</label>
                                                <input class="form-control" id="user_id" name="user_id" type="number" placeholder="User ID" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `lecturer`( `lecturer_id`, `lecturer_name`, `email`, `nic`, `start_date`, `phone_number`, `address`, `birth_date`, `user_id`, `type`, `faculty_id`, `active_status`) VALUES ('$lecturer_id','$lecturer_name','$email','$nic','$start_date','$phone_number','$address','$birth_date','$user_id','$type','$faculty_id','')";
    $conn->query($sql);
