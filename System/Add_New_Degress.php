            ...
            <li class="nav-item active">
                ...
                <div id="Degrees" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Add_New_Degress.php">Add New Degree</a>
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="degree_id" type="text" name="degree_id" placeholder="Degree ID" required>
                                            </div>
                                            <!-- Form Group (confirm password)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="degree_name">Degree Name</label>
                                                <input class="form-control" id="degree_name" name="degree_name" type="text" placeholder="Degree Name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="no_of_years">No of Years</label>
                                                <input class="form-control" id="no_of_years" type="text" name="no_of_years" placeholder="No of Years" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="department_id">Department ID</label>
                                                <input class="form-control" id="department_id" type="text" name="department_id" placeholder="Department ID" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $years=$_POST['no_of_years'];
    $department_id=$_POST['department_id'];
    
    $sql="INSERT INTO `degree`( `degree_id`, `degree_name`, `no_of_years`, `department_id`) VALUES ('$degree_id','$degree_name','$years','$department_id')";
    $conn->query($sql);
