            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Search in <?=$dep_name?></h1>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action = "C_CDetails.php">
                                        <div class="mb-3">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `degree`,`department` WHERE degree.department_id = department.department_id AND department.department_id = '$dep_id' ;";
                                        $result = $conn->query($sql);
