                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Remove Course [<?=$_GET['c_id']?>] From [<?=$d_id?>]</div>
                                    <div class="card-body">
                                        <form method="POST">
               
                                           
                                            <center>
                                                <h5><?=$c_name?> permently delete from your database </h5>
...
if (isset($_POST['ok'])) {
    ...
    $c_id=$_GET['c_id'];
    $sql="DELETE FROM `course` WHERE course.course_id = '$c_id' and course.degree_id = '$d_id'";
