...
if (isset($_GET['l_id'])) {
    $sql = "SELECT * FROM `lecturer` WHERE `lecturer_id`='".$_GET['l_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Lecturers" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item active" href="ManageLectures.php">Manage Lecturers</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Update Lecturer [<?=$_GET['l_id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="email" name="email" type="email" value="<?=$email?>" placeholder="Email" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="nic">NIC</label>
                                                <input class="form-control" id="nic" name="nic" type="text" value="<?=$nic?>" placeholder="NIC" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="start_date">Start Date</label>
                                                <input class="form-control" id="start_date" name="start_date" type="date" value="<?=$sd?>" placeholder="Start Date" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="phone_number">Phone Number</label>
                                                <input class="form-control" id="phone_number" name="phone_number" type="tel" value="<?=$phone_no?>" placeholder="Phone Number" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="address">Address</label>
                                                <input class="form-control" id="address" name="address" type="text" value="<?=$addr?>" placeholder="Address" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="birth_date">Birth Date</label>
                                                <input class="form-control" id="birth_date" name="birth_date" type="date" value="<?=$bd?>" placeholder="Birth Date" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="type">Type</label>
                                                <input class="form-control" id="type" name="type" type="text" value="<?=$type?>" placeholder="Type" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="faculty_id">Faculty ID</label>
                                                <input class="form-control" id="faculty_id" name="faculty_id" type="text" value="<?=$fac_id?>" placeholder="Faculty ID" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $bid=$_POST['birth_date'];
    $type=$_POST['type'];
    $fac_id=$_POST['faculty_id'];
    $lec_id=$_GET['l_id'];

    $sql="UPDATE `lecturer` SET `lecturer_name`='$lec_name',`email`='$email',`nic`='$nic',`start_date`='$std',`phone_number`='$phone',`address`='$address',`birth_date`='$bid',`type`='$type',`faculty_id`='$fac_id' WHERE lecturer.lecturer_id= '$lec_id';";

    $conn->query($sql);

    echo "<script>window.location.href='Managelectures.php';</script>";
}
?>