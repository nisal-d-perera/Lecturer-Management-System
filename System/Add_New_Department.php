            ...
            <li class="nav-item active">
                ...
                <div id="Departments" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Add_New_Department.php">Add New Department</a>
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="department_id" type="text" name="department_id"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="coordinator_id" type="text" name="coordinator_id"
                                                placeholder="Coordinator ID" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="small mb-1" for="faculty_id ">Faculty Id</label>
                                            <input class="form-control" id="faculty_id" type="text" name="faculty_id"
...
if (isset($_POST['submit'])) {
    ...
    $deprtment_id=$_POST['department_id'];
    $department_name=$_POST['department_name'];
    $coordinator_id=$_POST['coordinator_id'];
    $faculty_id=$_POST['faculty_id'];
    
    $sql="INSERT INTO `department`( `department_id`, `department_name`, `coordinator_id`, `faculty_id` ) VALUES ('$deprtment_id','$department_name','$coordinator_id','$faculty_id')";
    $conn->query($sql);
