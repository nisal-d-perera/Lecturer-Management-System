                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `department`,`faculty`, `lecturer` WHERE department.faculty_id = faculty.faculty_id and department.coordinator_id = lecturer.lecturer_id;";
                                        $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td><a href='Edit_Department.php?d_id=".$row["department_id"]."'>Edit</a></td>
                                                    </tr>";
                                                }
                                            } 
                                        ?>
