...
if ($_GET['de_id']) {
    $sql = "SELECT * FROM `degree` WHERE `degree_id`='".$_GET['de_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();

    $degree_name=$row["degree_name"];
    $no_year=$row["no_of_years"];
...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary-x sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="Degrees" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item active" href="ManageDegress.php">Manage Degrees</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Update Degree [<?=$_GET['de_id']?>] </div>
                                    <div class="card-body">
                                        <form method="POST">
               
                                           
                                            <div class="mb-3">
                                                <label class="small mb-1" for="degree_name">Degree Name</label>
                                                <input class="form-control" id="degree_name" name="degree_name" type="text" value="<?=$degree_name?>" placeholder="Degree Name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="no_of_years">No Of Years</label>
                                                <input class="form-control" id="no_of_years" name="no_of_years" type="text" value="<?=$no_year?>" placeholder="No Of Years" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="small mb-1" for="department_id">Department ID</label>
                                                <input class="form-control" id="department_id" name="department_id" type="text" value="<?=$dep_id?>" placeholder="Department ID" required>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $no_year=$_POST['no_of_years'];
    $depa_id=$_POST['department_id'];
    $de_id=$_GET['de_id'];

    $sql="UPDATE `degree` SET `degree_name`='$degree_name',`no_of_years`='$no_year',`department_id`='$depa_id' WHERE degree.degree_id= '$de_id';";
    $conn->query($sql);

    echo "<script>window.location.href='ManageDegress.php';</script>";
}
?>