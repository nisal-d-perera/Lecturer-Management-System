                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `degree`,`department` WHERE degree.department_id = department.department_id;";
                                        $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td><a href='Edit_Degree.php?de_id=".$row["degree_id"]."'>Edit</a></td>
                                                    </tr>";
                                                }
                                            } 
                                        ?>
