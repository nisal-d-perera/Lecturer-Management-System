...
if ($_GET['l_id']) {
    $sql = "SELECT * FROM `lecturer`,`user` WHERE `user`.`user_id` = `lecturer`.`user_id`  AND `lecturer`.`lecturer_id`='".$_GET['l_id']."' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();

    $l_id=$row["lecturer_id"];
    ...
    $sql = "SELECT * FROM `faculty` WHERE `faculty`.`faculty_id`='$fac_id' ;";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Details of [<?=$_GET['l_id']?>]</h1>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Lecturer Profile</div>
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mb-3">
                                                <center>
                                                    <a href='Edit_Lecturer.php?l_id=<?=$l_id?>'>Edit</a>
                                                </center>
                                            </div>
                                            <br>
