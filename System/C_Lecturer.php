                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Lecturers in <?=$dep_name?></h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM `lecturer`,`department`,`faculty` WHERE lecturer.faculty_id = faculty.faculty_id AND department.faculty_id = faculty.faculty_id AND department.department_id = '$dep_id';";
                                        $result = $conn->query($sql);
